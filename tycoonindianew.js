 ...
 * tycoonindianew.js
 *
 * tycoonindianew user interface script
 * 
...
function (dojo, declare, gamegui, counter) {
    return declare("bgagame.tycoonindianew", ebg.core.gamegui, {
        constructor: function(){
            console.log('tycoonindianew constructor');
        ...
        */
        ...
        /*
            ...
            Note: game notification names correspond to "notifyAllPlayers" and "notifyPlayer" calls in
                  your tycoonindianew.game.php file.

 ...
 * Influence: 4
 * Production: 2 Transport
 * Resources: Fuel, Minerals
 */
class Shipping extends IndustryCard {
  ...
  public static function production(): Effect {
    return parent::getEffect(FT::TRANSPORT, 2);
  }
  ...
  const RESOURCE_SECTORS = [Sector::FUEL, Sector::MINERALS];
}

...
class ShareActionDiscountMerit extends SingleEffectMeritCard {
  ...
  public static function benefit(): Effect {
    $args = [
      ...
      "fungibleType" => FungibleType::SHARE_ACTION_DISCOUNT,
      "amount" => 1,
      "multiplier" => StaticMultiplier::instance(1),
      "condition" => null,
      "spec"=> null,
      "trigger" => TriggerDefinition::instance(StringUtil::classToKebab(ShareAction::class), TriggerTiming::PRE, ShareAction::instance()),
      "next" => null,
      "roundDown" => false
    ];
  ...
  /** Constants - Misc */
  const NAME = "Share Action Discount";
  const NBR = 4;
}
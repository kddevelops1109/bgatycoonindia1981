...
class Madras extends City {

  public static function getOrCreate(array $args): static {
    return parent::instance($args, CityName::MADRAS, South::get());
  }
  ...
  public static function generateSpaceId(?array $args): string {
    return strtolower(StringUtil::strToKebab(CityName::MADRAS->value));
  }

  /**
   * Madras is the regional metro of the South region
   * @return bool
   */
  ...
  public function after(): City {
    return Coimbatore::get();
  }

  /** Constants - Misc */
  const NAME = CityName::MADRAS;

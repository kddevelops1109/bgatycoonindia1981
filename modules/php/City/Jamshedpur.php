...
class Jamshedpur extends City {

  public static function getOrCreate(array $args): static {
    return parent::instance($args, CityName::JAMSHEDPUR, East::get());
  }
  ...
  public static function generateSpaceId(?array $args): string {
    return strtolower(StringUtil::strToKebab(CityName::JAMSHEDPUR->value));
  }
  ...
  /** Constants - Misc */
  const NAME = CityName::JAMSHEDPUR;

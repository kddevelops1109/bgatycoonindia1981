...
class Mysore extends City {

  /**
   * Create new singleton instance of this city
   * @param array $args
   * @return City
   */
  public static function getOrCreate(array $args): static {
    return parent::instance($args, CityName::MYSORE, South::get());
  }
  ...
  public static function generateSpaceId(?array $args): string {
    return strtolower(StringUtil::strToKebab(CityName::MYSORE->value));
  }
  ...
  public function after(): City {
    return Bangalore::get();
  }

  /** Constants - Misc */
  const NAME = CityName::MYSORE;

...
class Vishakapatnam extends City {

  public static function getOrCreate(array $args): static {
    return parent::instance($args, CityName::VISHAKAPATNAM, South::get());
  }
  ...
  public static function generateSpaceId(?array $args): string {
    return strtolower(StringUtil::strToKebab(CityName::VISHAKAPATNAM->value));
  }
  ...
  /** Constants - Misc */
  const NAME = CityName::VISHAKAPATNAM;

 ...
 * @property int $cardId Unique identifier of this card (auto-generated by BGA if using the Deck builder)
 * @property string $cardType Type of card, such as Policy, Industry, etc
 * @property int $cardTypeArg Identifier for this card's type
 * @property string $cardLocation Location of this card's deck
 * @property int $cardLocationArg Position of card within its deck
 * @property string $cardName Name of this card
 * @property int $cardPromoters Number of promoters on this card
 * @property int $nbr Number of instances of this card
 */
abstract class Card extends DBO implements Fungible {
  ...
  /**
   * Static fields list common to all cards, if any
   * @return array
   */

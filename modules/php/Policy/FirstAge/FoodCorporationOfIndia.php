...
/**
 * Food Corporation of India is an Industrial Policy Card that gives owners
...
class FoodCorporationOfIndia extends IndustrialPolicyCard {
  ...
  /**
   * Influence provided by this policy
   * @return void
   */
  ...
  const NAME = \clienttranslate("Food Corporation of India");
  const DESCRIPTION = \clienttranslate("Established in 1965. The primary objective of the FCI is to ensure the availability of food grains at reasonable prices for the public distribution system and to maintain a sufficient buffer stock of food grains for the national food security.");
}
...
class LobbyStrategyMainActionManager extends StrategyMainActionManager {
  ...
  public function getSpaceDefinitions(): array {
    return [
      ["cost" => SAS::generateCost(5), "reward" => SAS::generateReward(FT::POLICY, 1), "index" => 1],
      ["cost" => SAS::generateCost(5), "reward" => SAS::generateReward(FT::POLICY, 1), "index" => 2],
      ["cost" => SAS::generateCost(5), "reward" => SAS::generateReward(FT::POLICY, 1), "index" => 3]
    ];
  }
}
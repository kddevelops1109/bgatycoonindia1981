...
use Bga\Games\tycoonindianew\Action\Free\BuildPlantAction;
...
class BuildPlantConglomerateBonusToken extends ConglomerateBonusToken {
  ...
  public static function conglomerateBonus(): Effect {
    $args = [
      ...
      "condition" => null,
      "spec" => new ActionSpec(BuildPlantAction::instance()),
      "trigger" => null,
      "next" => null,
      "roundDown" => false
    ];
  ...
  /** Constants - Misc */
  const NAME = "Build a Plant + Gain 4 Influence";
  const NBR = 1;
}
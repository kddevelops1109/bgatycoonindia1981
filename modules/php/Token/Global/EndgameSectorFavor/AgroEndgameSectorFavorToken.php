...
/**
 * Agro endgame sector favor token
 */
class AgroEndgameSectorFavorToken extends EndgameSectorFavorToken {
  ...
  public static function endgameSectorFavor(): Effect {
    $args = [
      ...
      "amount" => 1,
      "multiplier" => new DynamicMultiplier([IndustrialistManager::class, "getPlayerAgroSectorProduction"]),
      "condition" => null,
      "spec" => null,
      "trigger" => null,
      "next" => null,
  ...
  /** Constants - Misc */
  const NAME = Sector::AGRO->value;
  const NBR = 1;
  const SECTOR = Sector::AGRO;
}